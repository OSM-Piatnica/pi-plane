...
export default {
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      project_templates: {
        heading: "Szablony projektów",
        description:
          "Twórz gotowe wzorce projektów, aby szybciej uruchamiać nowe inicjatywy i utrzymywać spójny standard konfiguracji.",
        title: "Szablony projektów",
        add_template: "Dodaj szablon",
        loading: "Ładowanie szablonów...",
        none: "Brak szablonu",
        select_placeholder: "Wybierz szablon projektu",
        table: {
        ...
        form: {
          ...
          modal_intro:
            "Zapisz gotową konfigurację nowego projektu. Po zastosowaniu szablonu pola w formularzu tworzenia projektu zostaną automatycznie uzupełnione.",
          template_name_label: "Nazwa szablonu",
          template_name_placeholder: "np. Kampania marketingowa",
          template_note_label: "Opis",
          template_note_placeholder: "Kiedy warto użyć tego szablonu?",
          default_visibility: "Widoczność",
          default_lead: "Lider projektu",
          default_assignee: "Domyślnie przypisany",
          default_start_date: "Data startu",
          default_target_date: "Data końcowa",
          default_cover_image: "Domyślny URL tła",
          default_cover_image_placeholder: "https://... lub /static/background.webp",
          default_project_name: "Domyślna nazwa projektu",
          default_project_name_placeholder: "np. Wdrożenie Q3",
          default_project_identifier: "Domyślny identyfikator projektu",
          default_project_identifier_placeholder: "np. Q3ROLL",
          identifier_invalid: "Użyj tylko liter i cyfr (A-Z, 0-9).",
          identifier_max_char: "Identyfikator projektu nie może przekraczać 10 znaków.",
          enable_work_item_types: "Włącz typy elementów roboczych",
          section_template: "Szablon",
          section_properties: "Właściwości projektu",
          section_features: "Funkcje",
          section_features_hint: "Wybierz, które opcjonalne moduły mają być włączone w nowych projektach.",
          section_work_item_types: "Typy elementów roboczych",
          section_work_item_types_hint:
            "Skonfiguruj Task, Epiki i dodatkowe typy. Wymaga włączenia przełącznika „Typy elementów roboczych” w sekcji Funkcje.",
          section_states: "Stany",
          section_states_hint:
            "Zdefiniuj domyślne stany w pięciu grupach cyklu życia. Wybierz po jednym domyślnym w grupie.",
          section_labels: "Etykiety",
          section_labels_hint: "Ustaw etykiety, które będą dostępne od razu w każdym nowym projekcie.",
          default_states: "Domyślne stany",
          ...
          mark_default_state: "Ustaw jako domyślny stan w grupie",
          states_group_empty: "Brak stanu w tej grupie.",
          labels_empty: "Brak zdefiniowanych etykiet.",
          state_groups: {
            backlog: "Backlog",
            unstarted: "Do zrobienia",
            started: "W trakcie",
            completed: "Zakończone",
            cancelled: "Anulowane",
          },
          features: {
            cycles: {
              label: "Cykle",
              description: "Planuj pracę w iteracjach i dostosuj długość cyklu do potrzeb projektu.",
            },
            modules: {
              label: "Moduły",
              description: "Dziel projekt na podzespoły z własnym liderem i przypisanymi osobami.",
            },
            views: {
              label: "Widoki",
              description: "Zapisuj filtry, sortowania i ustawienia wyświetlania dla całego zespołu.",
            },
            pages: {
              label: "Strony",
              description: "Twórz notatki, dokumenty i materiały pomocnicze obok elementów roboczych.",
            },
            intake: {
              label: "Intake",
              description: "Przyjmuj zgłoszenia od osób spoza projektu bez zaśmiecania backlogu.",
            },
            time_tracking: {
              label: "Śledzenie czasu",
              description: "Rejestruj czas spędzony nad zadaniami i podsumowuj go w projekcie.",
            },
            work_item_types: {
              label: "Typy elementów roboczych",
              description: "Pozwól na definiowanie własnych typów elementów roboczych poza wbudowanymi.",
            },
          },
          custom_property: {
            title_label: "Tytuł",
            title_placeholder: "Tytuł właściwości",
            description_label: "Opis",
            description_placeholder: "Tekst pomocy dla tej właściwości (opcjonalnie)",
            type_label: "Typ właściwości",
            mandatory_checkbox: "Właściwość obowiązkowa",
            mandatory: "Obowiązkowa",
            inactive: "Nieaktywna",
            active_checkbox: "Aktywna",
            add_property: "Dodaj właściwość",
            dropdown_options_heading: "Opcje listy",
            select_mode_label: "Wybór",
            select_single: "Pojedynczy",
            select_multi: "Wielokrotny",
            default_option_label: "Domyślna opcja",
            no_default: "Brak domyślnej",
            option_placeholder: "Etykieta opcji",
            types: {
              text: "Tekst",
              number: "Liczba",
              ...
              boolean: "Logiczna",
              date: "Data",
              member_picker: "Wybór członka",
            },
          },
          work_item_types: {
            optional_badge: "Opcjonalne",
            default_badge: "Domyślny",
            disabled_hint:
              "Włącz „Typy elementów roboczych” w sekcji Funkcje powyżej, aby konfigurować Task, Epiki i dodatkowe typy.",
            properties_empty: "Brak właściwości. Dodaj pierwszą przyciskiem poniżej.",
            task: {
              title: "Task",
              description: "Domyślny typ elementu roboczego z możliwością dodawania nowych właściwości.",
            },
            epic: {
              title: "Epiki",
              description: "Dodaj niestandardowe właściwości do epika.",
              disabled: "Włącz Epiki przełącznikiem powyżej, aby skonfigurować właściwości epika.",
            },
            additional_section: {
              title: "Elementy robocze",
              description: "Zdefiniuj dodatkowe typy poza Task i Epic.",
              empty: "Brak typów. Dodaj pierwszy, aby lepiej uporządkować pracę.",
          ...
          default_project_description: "Domyślny opis projektu",
          default_project_description_placeholder: "Powtarzalny opis projektu (opcjonalnie).",
        },
        toasts: {
          ...
          delete_failed: { title: "Nie udało się usunąć szablonu", message: "Spróbuj ponownie za chwilę." },
          apply_failed: { message: "Nie udało się zastosować szablonu projektu." },
          apply_followup_failed: {
            message: "Projekt utworzono, ale nie udało się w pełni zastosować stanów lub etykiet z szablonu.",
          },
        },
        delete_confirm: "Czy chcesz usunąć ten szablon projektu?",
      },
      work_item_templates: {
