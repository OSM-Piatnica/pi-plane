...
export default {
  ...
  epic: {
    all: "Wszystkie epiki",
    label: "{count, plural, one {Epik} few {Epiki} other {Epików}}",
    new: "Nowy epik",
  ...
  account_settings: {
    ...
    activity: {
      description: "Śledź swoje ostatnie działania i zmiany we wszystkich projektach i elementach pracy.",
      heading: "Aktywność",
    },
    api_tokens: {
      description: "Generuj bezpieczne tokeny API, aby zintegrować swoje dane z zewnętrznymi systemami i aplikacjami.",
      heading: "Tokeny API",
    },
    notifications: {
      description:
    ...
    preferences: {
      description: "Dostosuj aplikację do swojego sposobu pracy",
      heading: "Preferencje",
    },
    security: {
  ...
  workspace_settings: {
    ...
    settings: {
      general: {
        ...
        errors: {
          ...
          company_size: {
            ...
            select_a_range: "Wybierz wielkość organizacji",
          },
        },
      },
      members: {
      ...
      billing_and_plans: {
        ...
        description: "Wybierz plan, zarządzaj subskrypcjami i łatwo przechodź na wyższy plan w miarę rozwoju potrzeb.",
        heading: "Płatności i plany",
      },
      exports: {
        ...
        exporting_projects: "Eksportowanie elementów pracy",
        format: "Format",
      },
      imports: {
        heading: "Importy",
      ...
      webhooks: {
        ...
        description: "Automatyzuj powiadomienia do usług zewnętrznych, gdy wystąpią zdarzenia w projekcie.",
        heading: "Webhooki",
      },
      api_tokens: {
        title: "Tokeny API",
  ...
  project_settings: {
    ...
    states: {
      ...
      description: "Zdefiniuj i dostosuj stany przepływu pracy, aby śledzić postęp elementów pracy.",
      heading: "Stany",
    },
    workflows: {
      heading: "Workflow",
    ...
    labels: {
      ...
      description: "Twórz własne etykiety, aby kategoryzować i porządkować elementy pracy",
      heading: "Etykiety",
    },
    estimates: {
      label: "Szacunki",
      ...
      enable_description: "Pomagają w komunikowaniu złożoności i obciążenia pracą zespołu.",
      heading: "Szacunki",
    },
    automations: {
      label: "Automatyzacja",
      ...
      description: "Skonfiguruj automatyczne akcje, aby usprawnić zarządzanie projektem i ograniczyć pracę ręczną.",
      heading: "Automatyzacja",
    },
    empty_state: {
      labels: {
        title: "Brak etykiet",
  ...
  accordion_navigation_control: "Nawigacja typu akordeon",
  approve: "Zatwierdź",
  back_to_workspace: "Powrót do przestrzeni roboczej",
  customize_navigation: "Dostosuj nawigację",
  enter_number_of_projects: "Podaj liczbę projektów",
  go_to_preferences: "Przejdź do preferencji",
  horizontal_navigation_bar: "Nawigacja z kartami",
  language_and_time: "Język i czas",
  language_setting: "Wybierz język używany w interfejsie użytkownika.",
  personal: "Osobiste",
  pin: "Przypnij",
  power_k: {
    account_actions: {
    ...
    contextual_actions: {
      cycle: {
        ...
        copy_url_toast_error: "Wystąpił błąd podczas kopiowania linku cyklu do schowka.",
        copy_url_toast_success: "Link do cyklu skopiowano do schowka.",
        indicator: "Cykl",
        remove_from_favorites: "Usuń z ulubionych",
        title: "Akcje cyklu",
      },
      module: {
        add_remove_members: "Dodaj/usuń członków",
        add_to_favorites: "Dodaj do ulubionych",
        change_status: "Zmień status",
        copy_url: "Kopiuj link",
        copy_url_toast_error: "Wystąpił błąd podczas kopiowania linku modułu do schowka.",
        copy_url_toast_success: "Link do modułu skopiowano do schowka.",
        indicator: "Moduł",
        remove_from_favorites: "Usuń z ulubionych",
        title: "Akcje modułu",
      },
      page: {
        ...
        archive: "Archiwizuj",
        copy_url: "Kopiuj link",
        copy_url_toast_error: "Wystąpił błąd podczas kopiowania linku strony do schowka.",
        copy_url_toast_success: "Link do strony skopiowano do schowka.",
        indicator: "Strona",
        lock: "Zablokuj",
        make_private: "Ustaw jako prywatną",
        make_public: "Ustaw jako publiczną",
        remove_from_favorites: "Usuń z ulubionych",
        restore: "Przywróć",
        title: "Akcje strony",
        unlock: "Odblokuj",
      ...
      work_item: {
        ...
        add_to_cycle: "Dodaj do cyklu",
        add_to_modules: "Dodaj do modułów",
        assign_to_me: "Przypisz do mnie",
        change_assignees: "Przypisz do",
        change_estimate: "Zmień szacowanie",
        change_priority: "Zmień priorytet",
        change_state: "Zmień stan",
        copy_id: "Kopiuj identyfikator",
        copy_id_toast_error: "Wystąpił błąd podczas kopiowania identyfikatora elementu pracy do schowka.",
        copy_id_toast_success: "Identyfikator elementu pracy skopiowano do schowka.",
        copy_title: "Kopiuj tytuł",
        copy_title_toast_error: "Wystąpił błąd podczas kopiowania tytułu elementu pracy do schowka.",
        copy_title_toast_success: "Tytuł elementu pracy skopiowano do schowka.",
        copy_url: "Kopiuj link",
        copy_url_toast_error: "Wystąpił błąd podczas kopiowania linku elementu pracy do schowka.",
        copy_url_toast_success: "Link do elementu pracy skopiowano do schowka.",
        delete: "Usuń",
        indicator: "Element pracy",
        subscribe: "Subskrybuj powiadomienia",
        title: "Akcje elementu pracy",
        unassign_from_me: "Cofnij przypisanie do mnie",
        unsubscribe: "Anuluj subskrypcję powiadomień",
      },
    },
    creation_actions: {
      create_cycle: "Nowy cykl",
      create_module: "Nowy moduł",
      create_page: "Nowa strona",
      create_project: "Nowy projekt",
      create_view: "Nowy widok",
      create_work_item: "Nowy element pracy",
      create_workspace: "Nowa przestrzeń robocza",
    },
    footer: {
      workspace_level: "Poziom przestrzeni roboczej",
    },
    ...
    help_actions: {
      ...
      join_forum: "Dołącz do naszego forum",
      open_keyboard_shortcuts: "Otwórz skróty klawiaturowe",
      open_plane_documentation: "Otwórz dokumentację Plane",
      report_bug: "Zgłoś błąd",
    },
    miscellaneous_actions: {
      copy_current_page_url: "Kopiuj link do bieżącej strony",
      copy_current_page_url_toast_error: "Wystąpił błąd podczas kopiowania linku bieżącej strony do schowka.",
      copy_current_page_url_toast_success: "Link do bieżącej strony skopiowano do schowka.",
      focus_top_nav_search: "Przejdź do pola wyszukiwania",
      toggle_app_sidebar: "Przełącz pasek boczny",
    },
    navigation_actions: {
      nav_account_settings: "Przejdź do ustawień konta",
      nav_all_workspace_work_items: "Przejdź do wszystkich elementów pracy",
      nav_assigned_workspace_work_items: "Przejdź do przypisanych elementów pracy",
      nav_created_workspace_work_items: "Przejdź do utworzonych elementów pracy",
      nav_home: "Przejdź do strony głównej",
      nav_inbox: "Przejdź do skrzynki odbiorczej",
      nav_project_archives: "Przejdź do archiwum projektu",
      nav_project_cycles: "Przejdź do cykli",
      nav_project_intake: "Przejdź do zgłoszeń",
      nav_project_modules: "Przejdź do modułów",
      nav_project_pages: "Przejdź do stron",
      nav_project_settings: "Przejdź do ustawień projektu",
      nav_project_views: "Przejdź do widoków projektu",
      nav_project_work_items: "Przejdź do elementów pracy",
      nav_projects_list: "Przejdź do listy projektów",
      nav_subscribed_workspace_work_items: "Przejdź do subskrybowanych elementów pracy",
      nav_workspace_analytics: "Przejdź do analiz przestrzeni roboczej",
      nav_workspace_archives: "Przejdź do archiwum przestrzeni roboczej",
      nav_workspace_drafts: "Przejdź do szkiców przestrzeni roboczej",
      nav_workspace_settings: "Przejdź do ustawień przestrzeni roboczej",
      nav_your_work: "Przejdź do swojej pracy",
      open_project: "Otwórz projekt",
      open_project_cycle: "Otwórz cykl",
      open_project_module: "Otwórz moduł",
      open_project_setting: "Otwórz ustawienie projektu",
      open_project_view: "Otwórz widok projektu",
      open_workspace: "Otwórz przestrzeń roboczą",
      open_workspace_setting: "Otwórz ustawienie przestrzeni roboczej",
    },
    page_placeholders: {
      default: "Wpisz polecenie lub wyszukaj",
      open_project: "Otwórz projekt",
      open_project_cycle: "Otwórz cykl",
      open_project_module: "Otwórz moduł",
      open_project_setting: "Otwórz ustawienie projektu",
      ...
      update_module_member: "Zmień członków",
      update_module_status: "Zmień status",
      update_start_of_week: "Zmień pierwszy dzień tygodnia",
      update_theme: "Zmień motyw",
      update_timezone: "Zmień strefę czasową",
      update_work_item_assignee: "Przypisz do",
      update_work_item_cycle: "Dodaj do cyklu",
      update_work_item_estimate: "Zmień szacowanie",
      update_work_item_labels: "Dodaj etykiety",
      update_work_item_module: "Dodaj do modułów",
      update_work_item_priority: "Zmień priorytet",
      update_work_item_state: "Zmień stan",
    },
    preferences_actions: {
      toast: {
        generic: {
          error: "Nie udało się zaktualizować preferencji. Spróbuj ponownie.",
          success: "Preferencje zostały zaktualizowane.",
        },
        theme: {
          error: "Nie udało się zaktualizować motywu. Spróbuj ponownie.",
          success: "Motyw został zaktualizowany.",
        },
        timezone: {
          error: "Nie udało się zaktualizować strefy czasowej. Spróbuj ponownie.",
          success: "Strefa czasowa została zaktualizowana.",
        },
      },
      update_language: "Zmień język interfejsu",
      update_start_of_week: "Zmień pierwszy dzień tygodnia",
      update_theme: "Zmień motyw interfejsu",
      update_timezone: "Zmień strefę czasową",
    },
    search_menu: {
