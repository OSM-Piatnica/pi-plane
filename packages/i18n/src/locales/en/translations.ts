  ...
  workspace_settings: {
    ...
    settings: {
      ...
      project_templates: {
        ...
        description:
          "Create reusable project blueprints to speed up project creation and keep setup consistent across teams.",
        title: "Project templates",
        add_template: "Add template",
        loading: "Loading templates...",
        none: "No template",
        select_placeholder: "Pick project template",
        table: {
        ...
        form: {
          ...
          modal_intro:
            "Save a reusable setup for new projects. Applied templates prefill project details in the create modal.",
          template_name_label: "Template name",
          template_name_placeholder: "e.g. Marketing campaign",
          template_note_label: "Description",
          template_note_placeholder: "When should this template be used?",
          default_visibility: "Visibility",
          default_lead: "Lead",
          default_assignee: "Default assignee",
          default_start_date: "Start date",
          default_target_date: "Target date",
          default_cover_image: "Default cover image URL",
          default_cover_image_placeholder: "https://... or /static/background.webp",
          default_project_name: "Default project name",
          default_project_name_placeholder: "e.g. Q3 Product Launch",
          default_project_identifier: "Default project ID",
          default_project_identifier_placeholder: "e.g. Q3LAUNCH",
          identifier_invalid: "Use only letters and numbers (A-Z, 0-9).",
          identifier_max_char: "Project ID should not exceed 10 characters.",
          enable_work_item_types: "Enable work item types",
          section_template: "Template",
          section_properties: "Project properties",
          section_features: "Features",
          section_features_hint: "Pick which optional modules new projects should ship with.",
          section_work_item_types: "Work item types",
          section_work_item_types_hint:
            'Shape Task, Epics, and extra types. Requires "Work item types" to be enabled under Features.',
          section_states: "States",
          section_states_hint: "Define default states grouped by lifecycle. Mark one default per group.",
          section_labels: "Labels",
          section_labels_hint: "Set the labels every project from this template starts with.",
          default_states: "Default states",
          default_labels: "Default labels",
          add_state: "Add state",
          add_label: "Add label",
          state_name_placeholder: "State name",
          label_name_placeholder: "Label name",
          mark_default_state: "Use as default state for this group",
          states_group_empty: "No state defined yet.",
          labels_empty: "No label defined yet.",
          state_groups: {
            backlog: "Backlog",
            unstarted: "Unstarted",
            started: "Started",
          ...
          features: {
            cycles: {
              label: "Cycles",
              description: "Timebox work into iterations and adjust their length per project.",
            },
            modules: {
              label: "Modules",
              description: "Group work into sub-projects with their own leads and assignees.",
            },
            views: {
              label: "Views",
              description: "Save filters, sort orders, and display options for the team.",
            },
            pages: {
              label: "Pages",
              description: "Capture notes, briefs, and project docs alongside work items.",
            },
            intake: {
              label: "Intake",
              description: "Collect bugs, ideas, and requests from people outside the project.",
            },
            time_tracking: {
              label: "Time tracking",
              description: "Log time spent on work items and roll it up at project level.",
            },
            work_item_types: {
              label: "Work item types",
              description: "Allow custom work item types beyond the built-in defaults.",
            },
          },
          custom_property: {
            title_label: "Title",
          ...
          work_item_types: {
            ...
            disabled_hint:
              'Enable "Work item types" in the Features section above to configure Task, Epics, and additional types.',
            properties_empty: "No custom properties yet. Add one with the button below.",
            task: {
              title: "Task",
            ...
            epic: {
              ...
              disabled: "Turn on Epics with the switch above to configure epic properties.",
            },
            additional_section: {
              title: "Work items",
              description: "Define extra work item types beyond Task and Epic.",
              empty: "No work items yet. Add one to structure your work better.",
              add_type: "Add work item type",
            },
            type_name_placeholder: "Type name",
            type_description_placeholder: "Short description (optional)",
          },
          default_project_description: "Default project description",
          default_project_description_placeholder: "Reusable project brief (optional).",
        },
        toasts: {
          created: { title: "Template created", message: "Project template has been saved." },
          create_failed: { title: "Could not create template", message: "Please review the form and try again." },
          deleted: { title: "Template removed", message: "Project template has been deleted." },
          delete_failed: { title: "Could not delete template", message: "Try again in a moment." },
          apply_failed: { message: "Failed to apply project template." },
          apply_followup_failed: {
            message: "Project was created, but template states or labels could not be fully applied.",
          },
        },
        delete_confirm: "Do you want to delete this project template?",
      },
      work_item_templates: {
