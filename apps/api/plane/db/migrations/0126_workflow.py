    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="workflow_state_configs",
                        to="db.state",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "flow_type",
                    models.CharField(
                        choices=[("transition", "Transition"), ("approval", "Approval")],
                        default="transition",
                        max_length=20,
                    ),
                ),
                ("allowed_roles", models.JSONField(blank=True, default=list)),
                ("allowed_members", models.JSONField(blank=True, default=list)),
                ("sequence", models.FloatField(default=65535)),
                (
                    "created_by",
                    models.ForeignKey(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("deleted_at__isnull", True), ("issue_type__isnull", False)),
