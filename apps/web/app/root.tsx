...
// fonts
// oxlint-disable-next-line eslint(import/no-unassigned-import) -- side-effect font CSS
...
export function HydrateFallback() {
  // Keep markup identical between prerendered HTML and the first client paint.
  // Branching on `window` / unresolved theme produced an empty <div> in Docker SPA
  // builds and triggered React hydration errors #418 / #423.
  return (
